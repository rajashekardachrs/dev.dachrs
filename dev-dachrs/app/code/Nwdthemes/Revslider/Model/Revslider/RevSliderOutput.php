...
class RevSliderOutput extends RevSliderFunctions {
	...
	public function get_image_data(){
		...
		$url_trans = 'data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=';
		...
		$img['src']			 = ($this->slider->get_param(array('general', 'lazyLoad'), false) != 'none') ? 'data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=' : $img['src'];
