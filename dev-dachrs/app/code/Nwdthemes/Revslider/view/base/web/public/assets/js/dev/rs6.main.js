					...
					if (data.loaded === undefined && loadobj !== undefined && loadobj.progress && loadobj.progress == "loaded") {
						if (loadobj.type == "img") {
							...
							if (data.slidebgimage) {
								if ((loadobj.src.indexOf('images/transparent.png') == -1 && loadobj.src.indexOf('assets/transparent.png') == -1 && loadobj.src.indexOf('data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=') == -1) || data.bgcolor === undefined) {
		...
		for (var i = 0; i < _R[id].slides.length; i++) {
			...
			if (B.bgvid.length > 0) {
				...
				if ((B.src !== undefined && B.src.indexOf('assets/dummy.png') == -1 && B.src.indexOf('assets/transparent.png') == -1) ||
					(B.lazyload !== undefined && B.lazyload.indexOf('assets/transparent.png') == -1 && B.lazyload.indexOf('assets/dummy.png') == -1 && B.lazyload.indexOf('data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=') == -1)) B.poster = true;
